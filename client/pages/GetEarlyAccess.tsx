  ...
  return (
    <PageWrapper>
      <div className="min-h-screen relative overflow-hidden">
        ...
        {/* Main Content */}
        <div className="relative z-10 min-h-screen px-10 sm:px-6 lg:px-20 pt-32 pb-16">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="order-1 xl:order-2">
                <div className="bg-transparent border border-lime-accent rounded-3xl p-8 lg:p-12 h-full flex flex-col items-center justify-center text-center">
                  {/* Icon */}
                  <svg
