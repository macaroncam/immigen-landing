    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 sm:px-6 lg:px-20 text-center pt-30 overflow-visible">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
                    <Link to="/get-early-access" className="flex items-center gap-2 bg-lime-accent text-black font-sans font-bold text-sm sm:text-base px-6 py-3 rounded-2xl hover:opacity-90 transition-opacity">
            Get Early Access
            <svg
              width="19"
              height="16"
