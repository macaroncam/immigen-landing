            ...
            <div className="relative bg-transparent rounded-3xl p-8 lg:p-12">
              ...
              <div className="relative z-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <label className="flex items-center">
                      <input
                        ...
                        onChange={handleInputChange}
                        className="w-4 h-4 text-lime-accent bg-transparent border border-white/30 rounded focus:ring-lime-accent focus:ring-2"
                      />
                      <span className="ml-2 text-sm font-sans text-white/70">
                        Remember me
                      </span>
                    </label>
                    <Link
                      to="/forgot-password"
                      className="text-sm font-sans text-lime-accent hover:text-lime-accent/80 transition-colors"
                    >
                      Forgot password?
                    </Link>
                  </div>
                  ...
                  <button
                    type="submit"
                    className="w-full flex items-center justify-center gap-2 bg-lime-accent text-black font-sans font-bold text-base px-8 py-4 rounded-xl hover:opacity-90 transition-opacity"
                  >
                    Sign In
                    <svg
                      width="19"
